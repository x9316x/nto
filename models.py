...
def insert_initial_data():
    ...
    # Добавляем виды бригад
    brigade_types = [
        ("Бригада по распиловке", "Занимается распиловкой древесины."),
        ("Бригада по сушке", "Занимается сушкой пиломатериалов."),
        ("Бригада по обработке", "Занимается обработкой древесины."),
        ("Бригада пеллетного цеха", "Производит пеллеты.")
]
    cursor.executemany("INSERT INTO brigade_types (name, description) VALUES (?, ?)", brigade_types)


    # Добавляем сотрудников
    employees = [
        ("Иванов Иван Иванович", 1985),
        ("Петров Петр Петрович", 1990),
        ("Сидоров Сидор Сидорович", 1982),
        ("Семенова Ирина Владимировна", 1987),
        ("Пушкин Александр Сергеевич", 1990),
        ("Якубович Леонид Аркадьевич", 1991),
        ("Павлов Ян Александрович", 1992),
        ("Медведев Даниил Петрович", 1993),
        ("Иванов Петр Петрович", 1994),
        ("Петров Иван Петрович", 1995),
        ("Петров Петр Иванович", 1989),
        ("Шматко Олег Александрович", 1988),
        ("Жуков Фёдор Фёдорович", 1987),
        ("Петров Петр Алексеевич", 1989),
        ("Алексеев Алексей Алексеевич", 1990)
]
    cursor.executemany("INSERT INTO employees (full_name, birth_year) VALUES (?, ?)", employees)


    # Добавляем расписание бригад
    brigade_schedules = [
        (1, 1, "2025-01-01", "1/1", "1 - Иванов Иван Иванович, 2 - Петров Петр Петрович, 3 - Сидоров Сидор Сидорович, 4 - Семенова Ирина Владимировна", "Иванов Иван Иванович"),
        (2, 2, "2025-01-01", "1/1", "5 - Пушкин Александр Сергеевич, 6 - Якубович Леонид Аркадьевич, 7 - Павлов Ян Александрович, 8 - Медведев Даниил Петрович", "Медведев Даниил Петрович"),
        (3, 3, "2025-01-01", "2/2", "11 - Петров Петр Иванович, 12 - Шматко Олег Александрович, 13 - Жуков Фёдор Фёдорович, 14 - Петров Петр Алексеевич, 15 - Алексеев Алексей Алексеевич", "Алексеев Алексей Алексеевич")
    ]
    cursor.executemany("""
